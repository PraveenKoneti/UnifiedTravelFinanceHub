...
class UnifiedTravelFinanceHub
{	
	public static void main(String args[])
	{
		System.out.println(cv.yellow+"\n\n \t\t\t\t\t\t  W E L C O M E   T O   T H E   U N I F I E D  T R A V E L  F I N A N C E  H U B  \n\n"+cv.reset);
		...
		{	
			System.out.println(cv.red+"\t\t\t\t\t\t\t  You are not Login to the CV HUB "+cv.reset);
		}
		System.out.println();
		System.out.println();
